...
#'        
#' @param stat.by  Compute adonis statistics and return results as an attribute 
#'        named 'stats'. (Default: \code{NULL})
#'        
#' @param perms  Number of random permutations to use in adonis calcuation (Default: 999)
#'        
#' @param seed  Random seed for adonis permutations. (Default: 0)
#'        
...
beta.div <- function (biom, method, weighted=TRUE, tree=NULL, long=FALSE, md=FALSE, safe=FALSE, stat.by=NULL, seed=0, perms=999) {
  ...
  attr(df, 'stats') <- attr(dm, 'stats', exact = TRUE)
