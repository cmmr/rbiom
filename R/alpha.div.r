...
#'     \describe{
#'       \item{\code{FALSE}}{ Use each sample's current set of observations 
...
#'     \code{Depth}, \code{OTUs}, \code{Shannon}, \code{Chao1}, \code{Simpson}, 
#'     \code{InvSimpson}. Non-ambiguous abbreviations are also accepted. The 
#'     default, \code{all}, returns all of them.
#'     
...
#'     diversity metrics: \bold{OTUs}, \bold{Shannon}, \bold{Chao1}, 
...
alpha.div <- function (biom, rarefy=FALSE, metrics="all", long=FALSE, md=FALSE, safe=FALSE) {
