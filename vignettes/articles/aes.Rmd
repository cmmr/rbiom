...
pals <- sapply(simplify = FALSE, names(rbiom:::PALETTES), function (i) {
  sprintf("<td align='right' style='padding-left:20px; padding-right:3px'>%s</td><td>%s</td>", i, 
...
In these cases, rbiom will select an appropriate palette to use.
...
```{r auto_facets1, fig.asp = 0.5}
adiv_boxplot(biom, adiv = c("Shannon", "Chao1"))
```

```{r auto_facets2, fig.asp = 0.5}
