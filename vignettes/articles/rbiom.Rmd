...
| `$id`, `$comment`        | Arbitrary strings for describing the dataset, or `""`. |
...
`bdiv_heatmap()`, `bdiv_ord_plot()`, `rare_barplot()`, `rare_corrplot()`, 
`rare_multiplot()`, `taxa_barplot()`, `taxa_boxplot()`, `taxa_corrplot()`, 
`taxa_heatmap()`
