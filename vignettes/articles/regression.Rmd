...
The most straight-forward plot is putting 'age' on the x-axis, 'height' on the y-axis, and overlaying a best-fit linear trendline.
...
Based on the above table, `fit = "gam"` has the lowest AIC, lowest BIC, and highest Log-Likelihood, and is therefore the best model to use for this set of data and variables.
