...
The most straight-forward plot is putting 'age' on the x-axis, 'height' on the y-axis, and drawing a straight line that minimizes the distances between the line and the observed data points.
...
We still have `test = "emtrends"`, so the p-value is reported where the difference in slope is most significant - in this case, at age = 5.83 years.
